...
import { groupBy, pipe, set } from 'remeda';
...
const Postgresql: NextPage = () => {
    ...
    const selectedTables = useMemo(() => {
        return [tableName, ...joins.map((join) => join.tableName)].filter((value) => value !== '');
    }, [tableName, joins]);
    ...
    const onExecuteQuery = () => {
        queryResult.mutate({ connectionString, selectedColumns, joins, tableName });
    ...
    return (
        <Layout>
            <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
                <h1 className="text-5xl font-extrabold tracking-tight text-white sm:text-[5rem]">PostgreSQL</h1>
                <LoginPostgres
                ...
                {schemaQuery.isError ? (
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex justify-center">
                            ...
                            <Button onClick={() => onExecuteQuery()}>Execute</Button>
                        </div>
                        <div>
